## systemPipeRdata: ChIP-Seq Workflow Template

<p align="right">
  <a href="https://systempipe.org/sprwf-chipseq-02-14-04/systemPipeChIPseq.html">
    <img src="https://img.shields.io/badge/TUTORIAL-blue?style=for-the-badge&logo=gitbook&logoColor=white" alt="Tutorial Badge">
  </a>
</p>

This is for workflow template of the systemPipeR Workflow Management System (WMS).
Detailed information about this specific workflow is available [here](https://systempipe.org/sprwf-chipseq-02-14-04/systemPipeChIPseq.html).
